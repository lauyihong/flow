...
class RingCrossNetwork(Network):
    """Ring road network.
    ...
    * **resolution** : number of nodes resolution
    ...
    def specify_routes(self, net_params):
        """See parent class."""
        rts = {
            "top": ["top", "left", "bottom", "right","central"],
            "left": ["left", "bottom", "right", "top"],
            "bottom": ["bottom", "right", "top", "left"],
            "right": ["right", "top", "left", "bottom"],
            "central":["central","left"],
            # "central2":["central2","bottom"]
        }
    ...
    def specify_edge_starts(self):
        ...
        edgestarts = [("bottom", 0),
                      ...
                      ("central", 0.5 * ring_length + 2 * junction_length),
                    #   ("central2", 0.5 * ring_length + 2 * junction_length),
    ...
    def specify_internal_edge_starts(self):
        ...
        edgestarts = [(":right_0", 0.25 * ring_length),
                      ...
                      (":central_0", 0.5 * ring_length + junction_length),
                    #   (":central2_0", 0.5 * ring_length + junction_length),
