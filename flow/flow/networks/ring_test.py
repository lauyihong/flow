...
class RingTestNetwork(Network):
    ...
    * **resolution** : number of nodes resolution
    ...
    #                   ("central", 0.25 * ring_length + junction_length)
    #                   ]
    #     print(f'edge starts: {edgestarts}')
    #     return edgestarts
